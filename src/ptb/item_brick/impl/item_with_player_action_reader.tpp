...
/**
 * \file
 * \brief Implementation of the ptb::item_with_player_action_reader class.
 ...
 */
template<class Base>
ptb::item_with_player_action_reader<Base>::item_with_player_action_reader()
 ...
 */
template<class Base>
void ptb::item_with_player_action_reader<Base>::add_pending_action
 ...
 */
template<class Base>
void ptb::item_with_player_action_reader<Base>::progress_input_actions
 ...
 */
template<class Base>
void ptb::item_with_player_action_reader<Base>::dummy_progress_input_actions
( bear::universe::time_type elapsed_time )
{
  m_date += elapsed_time;
 ...
 */
template<class Base>
void ptb::item_with_player_action_reader<Base>::start_action
 ...
 */
template<class Base>
void ptb::item_with_player_action_reader<Base>::do_action
 ...
 */
template<class Base>
void ptb::item_with_player_action_reader<Base>::stop_action
 ( unsigned int player_index, player_action::value_type a )
{
  // nothing to do
 ...
 */
template<class Base>
void ptb::item_with_player_action_reader<Base>::read_input_action
(bear::universe::time_type elapsed_time)
{
 ...
 */
template<class Base>
void ptb::item_with_player_action_reader<Base>::pop_actions
 ( bool send_action )
{
  bool ok(true);
 ...
 */
template<class Base>
bool ptb::item_with_player_action_reader<Base>::key_pressed
 ...
 */
template<class Base>
bool ptb::item_with_player_action_reader<Base>::key_released
( const bear::input::key_info& key )
{
  bool result = false;
  const unsigned int m( game_variables::get_players_count() );
 ...
 */
template<class Base>
bool ptb::item_with_player_action_reader<Base>::key_maintained
( bear::universe::time_type elapsed_time,
  const bear::input::key_info& key )
{
  bool result = false;
 ...
 */
template<class Base>
bool ptb::item_with_player_action_reader<Base>::button_pressed
 ...
 */
template<class Base>
bool ptb::item_with_player_action_reader<Base>::button_released
( bear::input::joystick::joy_code button, unsigned int joy_index )
{
  bool result = false;
  const unsigned int m( game_variables::get_players_count() );
 ...
 */
template<class Base>
bool ptb::item_with_player_action_reader<Base>::button_maintained
( bear::universe::time_type elapsed_time,
 bear::input::joystick::joy_code button, unsigned int joy_index )
{
  bool result = false;
 ...
 */
template<class Base>
bool ptb::item_with_player_action_reader<Base>::mouse_pressed
 ...
 */
template<class Base>
bool ptb::item_with_player_action_reader<Base>::mouse_released
( bear::input::mouse::mouse_code button,
  const claw::math::coordinate_2d<unsigned int>& pos )
{
  bool result = false;
 ...
 */
template<class Base>
bool ptb::item_with_player_action_reader<Base>::mouse_maintained
( bear::universe::time_type elapsed_time,
  bear::input::mouse::mouse_code button,
  const claw::math::coordinate_2d<unsigned int>& pos )
{
