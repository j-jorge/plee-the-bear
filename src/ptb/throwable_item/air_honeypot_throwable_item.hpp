 ...
 */
#ifndef __PTB_AIR_HONEYPOT_THROWABLE_ITEM_HPP__
#define __PTB_AIR_HONEYPOT_THROWABLE_ITEM_HPP__
...
namespace ptb
{
   ...
   */
  class air_honeypot_throwable_item
  ...
  public:
    explicit air_honeypot_throwable_item(const player_proxy& p);
...
#endif // __PTB_AIR_HONEYPOT_THROWABLE_ITEM_HPP__
